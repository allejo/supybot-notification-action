...
describe('Markup Parser', () => {
    describe('extractDirectives', () => {
        it('should extract nested directives', () => {
            const input = 'Just a <green>simple</green> test from <yellow:black><bold>me</bold></yellow:black>!';
    ...
    describe('formatStr function', () => {
        ...
        it('should handle foreground and background colors', () => {
            const actual = formatStr("Was #TheDress <white:yellow>white and gold</white:yellow> or <lightblue:black>black and blue</lightblue:black>");

            expect(actual).toEqual("Was #TheDress \u000300,08white and gold\u000f or \u000312,01black and blue\u000f");
        });

        it('should bold a word with <bold>', () => {
            const actual = formatStr("It's a <bold>bold</bold> strategy Cotton. Let's see if it pays off for him.");

            expect(actual).toEqual("It's a \u0002bold\u000f strategy Cotton. Let's see if it pays off for him.");
        });
